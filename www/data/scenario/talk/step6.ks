...
[if exp="f.tháng=12 && f.reven>=500000000"]
...
[day_up][dress_per_begin][hair_per_begin][head_per_begin][leg_per_begin][glass_per_begin][under_per_begin][other_per_begin][cloth_per_check][day_reset]
...
[if exp="f.r<=4 && f.r>=19"][eval exp="f.r='non'"][endif]
...
;;キャラ表示----------------------------------------------------------------------------------------------
*show_syl
[cm][chara_00][set_sit][f/s_nt][set_time][show_sit]
